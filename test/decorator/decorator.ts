...
namespace Decorator {
    class Decorator<T extends ThirdpartyLib.ILibraryItem> implements ThirdpartyLib.ILibraryItem {
    ...
    class Borrowable<T extends ThirdpartyLib.ILibraryItem> extends Decorator<T>
    {
        private borrowers: Array<string> = new Array<string>();
